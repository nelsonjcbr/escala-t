...
class UnidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create unidade" do
    assert_difference("Unidade.count") do
      post unidades_url, params: { unidade: { estabelecimento_id: @unidade.estabelecimento_id, nome: @unidade.nome } }
    end
  ...
  test "should update unidade" do
    patch unidade_url(@unidade), params: { unidade: { estabelecimento_id: @unidade.estabelecimento_id, nome: @unidade.nome } }
