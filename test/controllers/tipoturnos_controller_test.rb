...
class EquipesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipe" do
    assert_difference("Equipe.count") do
      post equipes_url, params: { equipe: { tipo_escala: @equipe.tipo_escala, titulo: @equipe.titulo } }
    end
  ...
  test "should update equipe" do
    patch equipe_url(@equipe), params: { equipe: { tipo_escala: @equipe.tipo_escala, titulo: @equipe.titulo } }
