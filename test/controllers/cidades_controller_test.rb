...
class CidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cidade" do
    assert_difference("Cidade.count") do
      post cidades_url, params: { cidade: { ibge: @cidade.ibge, nome: @cidade.nome, uf_id_id: @cidade.uf_id_id } }
    end
  ...
  test "should update cidade" do
    patch cidade_url(@cidade), params: { cidade: { ibge: @cidade.ibge, nome: @cidade.nome, uf_id_id: @cidade.uf_id_id } }
