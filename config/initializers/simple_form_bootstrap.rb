...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_boolean_devise, class: "form-check mb-0" do |b|
    ...
    b.use :label, class: 'form-check-label mb-0'
    b.use :full_error, wrap_with: { class: 'invalid-feedback' }
    b.use :hint, wrap_with: { class: 'form-text' }
  end
  ...
  config.wrappers :vertical_select, class: 'form-floating mb-3' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :readonly
    b.use :input, class: 'form-control', error_class: 'is-invalid', valid_class: 'is-valid'
  ...
  config.wrappers :vertical_date_datetimepicker, class: 'mb-3 form-floating', allowInput: "true" do |b|
    ...
    b.use :placeholder
    b.optional :pattern
    b.use :input, class: 'form-control datetimepicker', error_class: 'is-invalid', valid_class: 'is-valid'
    b.use :label
    b.use :full_error, wrap_with: { class: 'invalid-feedback' }
    b.use :hint, wrap_with: { class: 'form-text' }
  end
